...
public abstract class Entidade implements Serializable {
	...
	public List getAndOrderBy(String campo, Object valor, String campoOrder, boolean order) {
		try {
			...
			queryBuilder.orderBy(campoOrder, order);
	...
	public List notIn(String campo, List valores){
		try {
			QueryBuilder<String, Object> queryBuilder =
					this.daoImpl().queryBuilder();
			Where<String, Object> where = queryBuilder.where();

			where.notIn(campo, valores);
			PreparedQuery preparedQuery = queryBuilder.prepare();
